...
<div class="max-w-xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-800"><?php echo lang('title_add_type'); ?></h1>
    </div>

    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
        <form action="<?php echo URLROOT; ?>/admin/types_add" method="POST">
            <div class="space-y-6">
                
                <div>
                    <label class="block text-xs font-bold text-slate-700 mb-2 uppercase">Type Name (EN) *</label>
                    <input type="text" name="name" id="name_en" placeholder="e.g. Dress" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-primary">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="name_fr" id="name_fr" placeholder="ex: Robe" class="w-full bg-indigo-50/30 border border-indigo-100 rounded-xl px-4 py-3 focus:outline-none focus:border-indigo-500">
