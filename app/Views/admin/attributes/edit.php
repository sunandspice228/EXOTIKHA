...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500">Updating: <span class="font-bold text-primary bg-indigo-50 px-2 py-0.5 rounded border border-indigo-100"><?php echo $data['attribute']->name; ?></span></p>
        </div>
    </div>
        ...
        <form action="<?php echo URLROOT; ?>/admin/attributes_edit/<?php echo $data['attribute']->id; ?>" method="POST">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" value="<?php echo $data['attribute']->name; ?>" required 
            ...
            <div class="mb-6">
                <div class="flex justify-between items-end mb-2">
                    <label class="block text-xs font-bold text-slate-700 uppercase tracking-wide">Possible Values <span class="text-red-500">*</span></label>
                ...
                <textarea name="values" rows="4" required
                          class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition text-slate-800 leading-relaxed"><?php echo $data['attribute']->values_list; ?></textarea>
            </div>
            ...
            <div class="mb-8 p-4 bg-orange-50 border border-orange-100 rounded-xl flex gap-3 text-orange-700">
                ...
                <div class="text-xs leading-relaxed">
                    <strong class="block mb-1 uppercase tracking-wide font-bold">Caution</strong>
                    Removing a value from this list will affect existing products that use this variant. Please ensure no active inventory relies on the value you are deleting.
                </div>
            </div>
            ...
            <div class="flex items-center justify-end gap-4 border-t border-slate-50 pt-6">
                ...
                <button type="submit" class="bg-slate-900 text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-primary transition shadow-lg shadow-slate-900/20 flex items-center gap-2 transform hover:-translate-y-1">
                    <i class="fas fa-check-circle"></i> Update Attribute
                </button>
            </div>
        </form>
    </div>
