...
<div class="bg-slate-900 text-white py-20 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
        <span class="text-accent font-black uppercase tracking-widest text-xs mb-4 block animate-fade-in-down">Customer Care</span>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center hover:-translate-y-1 transition duration-300">
                ...
                <p class="text-slate-500 text-sm leading-relaxed">
                    ...
                    <a href="mailto:sales@exotikha.com" class="text-accent font-bold hover:underline">sales@exotikha.com</a>
                </p>
            </div>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center hover:-translate-y-1 transition duration-300">
                ...
                <p class="text-slate-500 text-sm leading-relaxed">
                    ...
                    <a href="https://wa.me/233539382808" class="text-accent font-bold hover:underline">+233 53 938 2808</a>
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div class="h-96 lg:h-auto bg-slate-200 relative">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3970.485606385223!2d-0.2035226241355152!3d5.642646232773539!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdf9c6e6f6f6f6f%3A0x0!2sHaatso%2C%20Accra!5e0!3m2!1sen!2sgh!4v1700000000000!5m2!1sen!2sgh" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="absolute inset-0 grayscale hover:grayscale-0 transition duration-700"></iframe>
            </div>
            ...
            <div class="p-8 lg:p-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" class="w-full rounded-xl border-slate-200 focus:ring-accent bg-slate-50 h-12 px-4 transition" placeholder="John Doe" required>
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase mb-2">Email Address</label>
                            <input type="email" name="email" class="w-full rounded-xl border-slate-200 focus:ring-accent bg-slate-50 h-12 px-4 transition" placeholder="john@example.com" required>
                        </div>
                    </div>
                    
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase mb-2">Subject</label>
                        <select name="subject" class="w-full rounded-xl border-slate-200 focus:ring-accent bg-slate-50 h-12 px-4 transition">
                    ...
                    <div>
                        ...
                        <textarea name="message" rows="5" class="w-full rounded-xl border-slate-200 focus:ring-accent bg-slate-50 p-4 transition" placeholder="How can we help you today?" required></textarea>
                    </div>

                    <button type="submit" class="w-full bg-slate-900 text-white py-4 rounded-xl font-bold hover:bg-accent transition shadow-lg uppercase tracking-widest text-sm flex justify-center items-center gap-2 group">
